// bt_proxy.h - Bluetooth to WiFi Proxy for RAK4631
#ifndef BT_PROXY_H
#define BT_PROXY_H
...
// Proxy statistics
typedef struct {
    bool ble_connected;           // Is BLE connected to RAK4631
...
// Scan for and connect to RAK4631
// device_name: Name or name pattern to search for (e.g., "RAK4631", "RAK")
...
// Send command/data to RAK4631 via BLE
